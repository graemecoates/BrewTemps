...
class segmentDisplay:
        ...
        def setupDisplay(self):
          self.bus.write_byte_data(self.addr,0x00,0x27)
        ...
        def writeDisplay(self,segment,value,decimal):
          ...
          self.bus.write_byte_data(self.addr, int(self.cmd), int(self.val))

        def clearDisplay(self,segment):
          seg = { 1 : 0x01, 2 : 0x02, 3 : 0x03, 4 : 0x04}
          self.cmd = seg[segment]
          self.bus.write_byte_data(self.addr, int(self.cmd), 0x00)
